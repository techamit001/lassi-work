                                ...
                                <div class="wpb_column vc_column_container vc_col-sm-12">
                                    <div class="vc_column-inner ">
                                        <div class="wpb_wrapper">
                                            <h2 class="sc_title sc_title_regular sc_align_center margin_bottom_small">Lassi Joy</h2>
                                            ...
                                            <div id="sc_tabs_730" class="sc_tabs sc_tabs_style_2 margin_top_large" data-active="0">
                                                <ul class="sc_tabs_titles">
                                                    <li class="sc_tabs_title">
                                                        <a href="#sc_tab_131-2" class="theme_button" id="sc_tab_131-2_tab">LASSI</a>
                                                    </li>
                                                    <li class="sc_tabs_title">
                                                        <a href="#sc_tab_263-2" class="theme_button" id="sc_tab_263-2_tab">SHAKES</a>
                                                    </li>
                                                    <li class="sc_tabs_title">
                                                        <a href="#sc_tab_363-4" class="theme_button" id="sc_tab_363-4_tab">FRESH JUICE</a>
                                                    </li>
                                                    <li class="sc_tabs_title">
                                                        <a href="#sc_tab_454-9" class="theme_button" id="sc_tab_454-9_tab">COFFEE</a>
                                                    </li>
                                                    <li class="sc_tabs_title">
                                                        <a href="#sc_tab_552-0" class="theme_button" id="sc_tab_552-0_tab">FALUDA & KULFI</a>
                                                    </li>
                                                </ul>
                                                            ...
                                                            <div class="sc_columns columns_wrap">
                                                                ...
                                                                <div class="column-1_2 column_padding_bottom">
                                                                    <div id="sc_menuitems_347_3" class="sc_menuitems_item sc_menuitems_item_3" data-url="menu-item-1.html">
                                                                        ...
                                                                        <div class="sc_menuitem_price">₹40</div>
                                                                        <div class="sc_menuitem_title">
                                                                ...
                                                                <div class="column-1_2 column_padding_bottom">
                                                                    <div id="sc_menuitems_347_5" class="sc_menuitems_item sc_menuitems_item_5" data-url="menu-item-1.html">
                                                                        ...
                                                                        <div class="sc_menuitem_price">₹50</div>
                                                                        <div class="sc_menuitem_title">
                                                                ...
                                                                <div class="column-1_2 column_padding_bottom">
                                                                    <div id="sc_menuitems_347_6" class="sc_menuitems_item sc_menuitems_item_6" data-url="menu-item-2.html">
                                                                        ...
                                                                        <div class="sc_menuitem_price">₹60</div>
                                                                        <div class="sc_menuitem_title">
                                                                ...
                                                                <div class="column-1_2 column_padding_bottom">
                                                                    <div id="sc_menuitems_347_6" class="sc_menuitems_item sc_menuitems_item_6" data-url="menu-item-2.html">
                                                                        ...
                                                                        <div class="sc_menuitem_price">₹70</div>
                                                                        <div class="sc_menuitem_title">
                                                            ...
                                                            <div class="sc_columns columns_wrap">
                                                                ...
                                                                <div class="column-1_2 column_padding_bottom">
                                                                    <div id="sc_menuitems_591_5" class="sc_menuitems_item sc_menuitems_item_5" data-url="menu-item-1.html">
                                                                        ...
                                                                        <div class="sc_menuitem_price">₹80</div>
                                                                        <div class="sc_menuitem_title">
                                                            ...
                                                            <div class="sc_columns columns_wrap">
                                                                ...
                                                                <div class="column-1_2 column_padding_bottom">
                                                                    <div id="sc_menuitems_270_6" class="sc_menuitems_item sc_menuitems_item_6" data-url="menu-item-2.html">
                                                                        ...
                                                                        <div class="sc_menuitem_price">₹90</div>
                                                                        <div class="sc_menuitem_title">
